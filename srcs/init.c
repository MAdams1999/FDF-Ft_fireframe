...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/12 13:28:36 by madams            #+#    #+#             */
/*   Updated: 2019/07/12 14:07:48 by madams           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** "error.h" for ERR_MAP_INIT macros, ERR_FDF_INIT macros
...
t_map		*map_init(void)
{
	...
	map->coords_arr = NULL;
	map->colors_arr = NULL;
	map->a_min = FT_INT_MAX;
	map->a_max = FT_INT_MIN;
	map->z_range = 0;
	return (map);
}
